...
flags.DEFINE_string("dataset", "0_128", "The name of dataset [celebA, mnist, lsun]")
  ...
  with tf.Session(config=run_config) as sess:
    if FLAGS.dataset == 'mnist':
      dcgan = DCGAN(
          ...
          input_fname_pattern=FLAGS.input_fname_pattern,#*.jpg
          crop=FLAGS.crop,
      ...
      dcgan = DCGAN(
          ...
          sample_num=FLAGS.batch_size,#64
          z_dim=FLAGS.generate_test_images,#随机噪声
          dataset_name=FLAGS.dataset,#0_128
          input_fname_pattern=FLAGS.input_fname_pattern, #*.jpg
          crop=FLAGS.crop, #flase
          checkpoint_dir=FLAGS.checkpoint_dir,
          sample_dir=FLAGS.sample_dir,
          data_dir=FLAGS.data_dir)
